...
gh secret set TERRAFORM_STATE_BUCKET_NAME     --org "$ORG_NAME" --visibility all --body "$BUCKET_NAME"
gh secret set TERRAFORM_STATE_BUCKET_LOCATION --org "$ORG_NAME" --visibility all --body "$BUCKET_LOCATION"
gh secret set TERRAFORM_STATE_BUCKET_ENDPOINT --org "$ORG_NAME" --visibility all --body "$BUCKET_ENDPOINT"
gh secret set TERRAFORM_STATE_TOKEN_ID        --org "$ORG_NAME" --visibility all --body "$TOKEN_ID"
gh secret set TERRAFORM_STATE_TOKEN_VALUE     --org "$ORG_NAME" --visibility all --body "$TOKEN_VALUE"
